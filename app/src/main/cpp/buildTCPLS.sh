...
cp libpicotcpls-jni.so liblog.so libpicotls-core.so libpicotls-minicrypto.so libpicotls-openssl.so /home/aubuchet/Documents/memoire/TCPLS/app/app/libs/$target
